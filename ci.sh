...
# 2018.May26
## 💚 RELEASE 1.0.0.May26.2018: first formal release
...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/transport-tracker
############
# Step: 07 #
############
...
git push --all -f https://github.com/sakib-rahman-bangladesh/transport-tracker